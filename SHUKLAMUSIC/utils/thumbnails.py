...
async def get_thumb(videoid, chat_id):
    ...
    try:
        ...
        bg = Image.open(f"SHUKLAMUSIC/assets/bg2.png")
        ...
        font = ImageFont.truetype("SHUKLAMUSIC/assets/font2.ttf", 45)
        ImageFont.truetype("SHUKLAMUSIC/assets/font2.ttf", 70)
        arial = ImageFont.truetype("SHUKLAMUSIC/assets/font2.ttf", 30)
        ImageFont.truetype("SHUKLAMUSIC/assets/font.ttf", 30)
